...
// Class For Arduino Mega 2560 Rev3
class ArduinoMega : public ArduinoBoard {
public:
    ArduinoMega();
    ~ArduinoMega() override = default;
...
private:
    static constexpr uint8_t HW_MAX_PINS = 70;
    static  ArduinoBoard::hw_pin_meta_t s_gpio_pins[HW_MAX_PINS]; // declaration
