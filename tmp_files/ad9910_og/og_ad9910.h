...
/******************************************************************************
 * AD9910 HW3.x - DDS Power Supply 3.3V - 1.8V
...
#include <stdlib.h> // standard library functions: memory allocation
#include <limits.h> // limits of integer types,
#include <SPI.h>    // Arduino-specific library for SPI communication.
...
#define DDS_MASTER_RESET_PIN           14
...
#define DDS_PROFILE_0_PIN       15
#define DDS_PROFILE_0_GPIO_PORT GPIOC 

#define DDS_PROFILE_1_PIN       16
#define DDS_PROFILE_1_GPIO_PORT GPIOC 

#define DDS_PROFILE_2_PIN       17
...
void DigitalRamp(uint32_t FTWStart, uint32_t FTWEnd, uint32_t FTWStepSize, uint16_t StepRate, bool continuous = true);
void Sweep(uint32_t StartSweepFreq, uint32_t StopSweepFreq, uint16_t SweepTime, uint8_t SweepTimeFormat, bool continuous = true);
